...
os.execute("cp icons/game_icon_2.png build/temp/resources/icon.png")
os.execute("cp icons/game_icon_2.ico build/temp/resources/icon.ico")
...
os.execute("cp -r mods/Noesis/* build/temp/")
