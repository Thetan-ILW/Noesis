...
config.data = --[[data]] {
	...
	OverallDifficulty = 5,
	autosave = false,
	covers = {bottom = {enabled = false,  position = 240,  size = 47}, top = {enabled = false,  position = 240,  size = 48}},
	mania = {ComboPosition = 280, HitPosition = 456, ScorePosition = 300, SplitStages = 0, UpsideDown = 0}
} --[[/data]]
